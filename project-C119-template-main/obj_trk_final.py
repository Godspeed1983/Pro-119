...
video = cv2.VideoCapture("C:/Users/Adit Kadiyan/Downloads/project-C119-template-main/project-C119-template-main/footvolleyball.mp4")
#load tracker 
...
while True:
    ...
    if success:
        ...
        cv2.putText(img,"Lost",(75,90),cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,0.7,(0,0,225),2)
